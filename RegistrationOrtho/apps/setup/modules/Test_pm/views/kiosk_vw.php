     ...
     <div id="wrapper">
        ...
        <div class="container-fluid">
           <div class="container">
              ...
              <div style="font-family: cs_prajad_b;font-weight: 400;font-size: 30px;">ตั้งค่าชื่อคีออส</div>
              <div class="row">
                 <div class="col-12 mb-2">
                    <div class="float-left"><a href="javascript:void(0);" class="btn btn_pmk btn-sm" data-toggle="modal" data-target="#add_modal" style="font-family:cs_prajad_b;font-weight: 300;font-size: 18px;" id="btn-add">เพิ่ม kiosk</a></div>
                 </div>
              </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-zoom">
           <div class="modal-content">
              <div class="modal-header">
                 <div style="font-family: cs_prajad_b;font-size: 30px;">kiosk</div>
              </div>
              <div class="modal-body">
                 <form class="form-horizontal" id="submit" enctype='multipart/form-data'>
                    ...
                    <div class="form-group" style="font-family: cs_prajad_b;font-size: 18px;">
                       ชื่อ kiosk
                       <input type="number" name="code" class="form-control" placeholder="ระบุชื่อ kisok" id="code">
                       <div id="validate-code" style="color:red;"></div>
                    </div>

                    <div class="form-group" style="font-family: cs_prajad_b;font-size: 18px;">
                       <p id="Linkkiosk"></p>
                       <a href="#" style="font-size: 14px;" id="link_kiosk"></a>
                    </div>
