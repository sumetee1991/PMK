...
<ul class="navbar-nav  sidebar  bg-light  sidebar-dark accordion" id="accordionSidebar" style="background-color: #fff;border-right:1px solid #ccc;">
   ...
   <li class="nav-item li1" id="li1">
      <a class="nav-link i2" href="/index">
         <i class="fab fa-fw fa-quora i1" id="i1"></i>
         <span style="font-family: cs_prajad_b;font-weight: 400;font-size: 20px;">kiosk</span></a>
   </li>
   ...
   <li class="nav-item li6">
      <a class="nav-link" href="/clinic">
         ...
         <span style="font-family: cs_prajad_b;font-weight: 400;font-size: 20px;">จำนวนที่รับ walk-in</span></a>
   </li>
   <!-- <li class="nav-item">
   ...
   <li class="nav-item li7">
      <a class="nav-link" href="/report">
         <i class="fas fa-table"></i>
         <span style="font-family: cs_prajad_b;font-weight: 400;font-size: 20px;">Report (ตาราง)</span></a>
   </li>
   <li class="nav-item li8">
      <a class="nav-link" href="/statistic">
         <i class="fas fa-chart-bar"></i>
         <span style="font-family: cs_prajad_b;font-weight: 400;font-size: 20px;">Report (กราฟ)</span></a>
   </li>
