            ...
            success: function(data) {
               ...
               for (i = 0; i < data.length; i++) {
                  html += '<div class="col-lg-4 col-sm-6 col-12 mb-2"><div class="card shadow h-100 bg-light"><div class="card-body"><input type="hidden" value="' + j + '" data-sort="' + data[i].uid + '">' +
                     ...
                     '<div>' +
                     '<a href="javascript:void(0);" class="btn btn_pmk btn-sm item_edit" data-uid="' + data[i].uid + '" data-code="' + data[i].code + '" data-name="' + data[i].name + '" data-short-name="' + data[i].shortname + '" data-hiscode="' + data[i].hiscode + '" data-groupprocess="' + data[i].groupprocessuid + '" data-counter="'+data[i].counter+'" data-openactive="' + data[i].openactive + '" data-active="' + data[i].active + '" style="font-family:cs_prajad_b;font-size:18px;font-weight:300;"><i class="fa fa-edit" aria-hidden="true"></i> แก้ไข</a>' + ' ' +
