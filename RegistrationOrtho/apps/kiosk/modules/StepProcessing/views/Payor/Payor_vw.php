<input type='hidden' id="hiscode_se">
<input type='hidden' id="payorauto_se">
<div class="form-group">
	...
	<div style="height: 39rem">
		<div class="row form-group col-12 center" id="" style="">
			...
			<div class="col-12 row bodyth" style="display: inherit; padding: 16px 3rem; overflow-y:auto; height:30rem;" id="area_box_payyor">
