<script>
    ...
    $(document).ready(function() {
        ...
        $("#conf_yes").click(function() {
            ...
            //  var list_holderid = [];
            // alert('CHECKOFFLINE : '+checkofflinemode);
            //         if(checkofflinemode=="Manual"){
            ...
            if (check_scan == 'false') {
                ...
                // CHECK SCAN TRUE
                // alert('HISCODE : ' + hiscode);
                // alert('Payor Active :'+ payor_active)
                if ((worklistgroup == 1 || worklistgroup == 2) && (payor_active == 23 || payor_active == 24) && list_holderid.indexOf(hiscode) !== -1) {
                    $.ajax({ //เช็ค api สิทธิเปิดที่นี้ ไม่ตรงlast  จะ เปิดได้ไหม
                    ...
                    // ไม่เปิดสิทธิ์ CHECK SCAN TRUE
                    if (payor_active !== '26' && (worklistgroup == '3' || worklistgroup == '13' || worklistgroup == '23')) {
                        $.ajax({ //create session user info
                            url: UrlBaseCont + '/StepProcessing/UpdateUserInfo',
                            type: "post",
                            dataType: "json",
