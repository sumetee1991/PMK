		...
		<div>
			...
			<div class="container-fluid" style="font-size: 1.5rem;">
				<ul class="nobullet">
					...
					<li><img style="width: 20px" src="<?=base_url('static/Icon');?>/2.png" alt=""><a class="sidenav_url" href="./AltDashboard"><button>คิวทำประวัติผู้ป่วย</button></a></li>
					<li><img style="width: 20px" src="<?=base_url('static/Icon');?>/3.png" alt=""><a class="sidenav_url" href="./Dashboard"><button>คิวเปิดสิทธิ</button></a></li>
