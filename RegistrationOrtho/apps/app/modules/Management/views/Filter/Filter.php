<div class="main_container">
	<div class="row align-items-center" style="height: 94px;">
		...
		<span id="TabPatientName" data-refno="" data-patientuid="" data-patienthn="" data-idcard="" style="font-size:2.5rem;color:#0000FF;"></span>
		<br>
						...
						<?php if(isset($Data['Building_Room']) && count($Data['Building_Room']) > 0): ?>
							<?php foreach($Data['Building_Room'] as $Room): ?>
								...
								<div class="col-4" style="text-align: center;padding:5px 25px;">
									<button class="building_room" data-buildinguid="<?=$Room->buildinguid;?>" data-flooruid="<?=$Room->flooruid;?>" data-opdcode="<?=$Room->clinic_code;?>" data-tabfilter="<?=$Room->uid;?>" data-tabaction="tabfilter" data-visitactive="<?=$Room->visit_active;?>"><?=$Room->detail;?></button>
