 ...
 <div>
   ...
   <div class="container-fluid" style="font-size: 1.5rem;">
     <ul class="nobullet" id='menu'>
      ...
      <li><img style="width: 26px" src="<?=base_url('static/Icon');?>/1.png" alt=""><a class="sidenav_url menu" href="./Filter/0" location="1" uid="3"><button>คัดกรอง</button></a></li>
      <li><img style="width: 20px" src="<?=base_url('static/Icon');?>/2.png" alt=""><a class="sidenav_url menu" href="./AltDashboard" location="1" uid="1"><button>คิวทำประวัติผู้ป่วย</button></a></li>
      <li><img style="width: 20px" src="<?=base_url('static/Icon');?>/3.png" alt=""><a class="sidenav_url menu" href="./Dashboard" location="1" uid="2"><button>คิวทำประวัติและเปิดสิทธิ</button></a></li>
      <li id="SetupBtn" class="sidenav_url"><img style="width: 20px" src="<?=base_url('static/Icon');?>/4.png" alt=""><button>ตั้งค่าเคาน์เตอร์</button></li>
   </ul>
</div>
</div>
</div>
