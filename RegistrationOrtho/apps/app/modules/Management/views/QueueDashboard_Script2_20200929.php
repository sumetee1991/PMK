<script type="text/javascript">
	...
	$(document).ready(function() {
      ...
      $('#menu').html('<li><img style="width: 20px" src="<?=base_url('static/Icon');?>/3.png" alt=""><a class="sidenav_url" href="./AltDashboardlocation2"><button>คิวทำประวัติและเปิดสิทธิ</button></a></li>'+
         ...
         '<li id="SetupBtn"><img style="width: 20px" src="<?=base_url('static/Icon');?>/4.png" alt=""><a <?php /*  href="<?=base_url(LOCALPATH.'/Management/Setup');?>" */ ?> target="_blank"><button>ตั้งค่าเคาน์เตอร์</button></a></li>');
