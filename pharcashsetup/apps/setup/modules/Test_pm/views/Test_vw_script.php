     ...
     $.ajax({
       ...
       success : function(data){
         ...
         for(i=0; i<data.length; i++){
            ...
            '<div>'+
            '<a href="javascript:void(0);" class="btn btn_pmk btn-sm item_edit btn_edit" data-uid="'+data[i].uid+'" data-product-name="'+data[i].countername+'" data-groupprocess="'+data[i].groupprocessuid+'" data-active="'+data[i].active+'"><i class="fa fa-edit" aria-hidden="true"></i> แก้ไข</a>'+' '+
