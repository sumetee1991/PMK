...
window.addEventListener('storage', function(e) {  
 ...
 $('#add_building').click(function() {  
    ...
    $('#building_set').append('<div class="row" id="row'+i+'">'+
      ...
      '<div class="col-6"><div class="form-group"><input type="text" class="form-control patient_type_data" name="floor[floor][]" id="floor'+i+'" style="font-family:cs_prajad_b;" value="" placeholder="ชื่อชั้น"></div></div>'
