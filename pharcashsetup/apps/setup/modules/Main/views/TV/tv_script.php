<script type="text/javascript">
    ...
    const queuecode_dropdown = async (queuelocationuid) => {        
        let url  = `./get_queuelist_queuelocation/${queuelocationuid}`;
    ...
    const message_modal = (uid) => {
        ...
        $.get({
            ...
            .then( async (response) => {
                ...
                let queuedropdown = await queuecode_dropdown(queuelocationuid);
                let display_html = ``;
                ...
                let display_qty = (uid,tvuid) => {
                    ...
                    `;
                    for (let qty_row = 1; qty_row <= 8; qty_row++) {
                        html +=`
