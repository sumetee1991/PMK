...
<table id="usercontrol_div" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline collapsed" cellspacing="0" style="display:none">
    <thead>
        <tr>
