<div class="container-fluid">
    <div class="row">
        <div class="col mb-2">
            <a class="btn btn_pmk btn-sm" style="font-family:cs_prajad_b;font-weight: 300;font-size: 18px;" btn-add href="javascript:void(0);">Add Counter</a>
        </div>
    ...
    <div id="counter_list" class="row ui-sortable">
        <?php foreach ($Data['Counter'] as $key => $value) : ?>
            <div class="col-lg-4 col-sm-6 col-12 mb-2 ui-sortable-handle" sortcate data-uid="<?=$value->uid;?>">
                <div class="card  shadow h-100  bg-light">
                    <div class="card-body">
                        <input type="hidden" value="1" data-sort="<?= $value->sq; ?>">
                        <div style="font-size:20px;font-family:cs_prajad_b;font-weight:300;">Counterno : <?= $value->counterno; ?></div>
                        <span><?= $value->computername . ($value->ipaddress ? " | $value->ipaddress" : ""); ?></span>
                        <div>
...
<div class="modal fade" id="counter_modal" style="display: none;" aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="font-family: cs_prajad_b;font-size: 18px;">
                        Computer Name
                        <input name="computername" id="input_computername" placeholder="Computer Name" type="text" class="form-control">
                    </div>

                    <div class="form-group" style="font-family: cs_prajad_b;font-size: 18px;">
                        IP Address
                        <input name="ipaddress" id="input_ipaddress" placeholder="IP Address" type="text" class="form-control">
                    </div>

                    <div class="form-group" style="font-family: cs_prajad_b;font-size: 18px;">
                        Counterno
                        <input name="counterno" id="input_counterno" placeholder="Counterno" type="text" class="form-control">
                    </div>
                    ...
                    <div class="form-group" style="font-family: cs_prajad_b;font-size: 18px;">
                        Active
                        <div class="col">
                            <input type="radio" name="statusflag" value="A" checked="checked">เปิด
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="del_confirm" class="btn btn-success" data-delete="counter" data-uid="">ยืนยัน</a>
            </div>
        </div>
    </div>
</div>