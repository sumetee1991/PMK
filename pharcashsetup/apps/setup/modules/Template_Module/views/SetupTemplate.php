...
<head>
    ...
    <?= assets_css(array(
        ...
        'select2-4.1.0' => 'jquerydataTable/select2-4.1.0/dist/css/select2.min.css',
    )); ?>
    <style type="text/css">
        #show_data .card {
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                <div class="container-fluid">
                    ...
                    <div id="show_data" class="" style="overflow-x:auto;">
                        <?php
    ...
    <?= assets_js(array(
        ...
        'select2-4.1.0' => 'jquerydataTable/select2-4.1.0/dist/js/select2.min.js',
    )); ?>
