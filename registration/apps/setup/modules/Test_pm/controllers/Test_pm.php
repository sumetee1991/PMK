   ...
   public function report_ajax(){
      ...
      switch($Input['topic']){
         case 0:
            ...
            break;
         case 1:
            $views['Data_Count'] = $this->Counter->getMedQueueReport_count($Input['date_from'], $Input['date_to']);
         ...
         case 3:
            ...
            break;
         case 4:
            $views['Data'] = $this->Counter->getReportAll($Input['date_from'],$Input['date_to']);
            $output['table'] = "management_reportall";
            $output['html'] = $this->load->view('Report/ajax/reportall',$views,TRUE);
            break;
         default:
