       ...
       $.ajax({
        ...
        success : function(data){
         ...
         for(i=0; i<data.length; i++){
            ...
            '<div>'+
            '<a href="javascript:void(0);" class="btn btn_edit btn_pmk btn-sm item_edit" data-uid="'+data[i].uid+'" data-code="'+data[i].code+'" data-description="'+data[i].description+'" data-groupprocess="'+data[i].groupprocessuid+'"   style="font-family:cs_prajad_b;font-size:18px;font-weight:300;"><i class="fa fa-edit" aria-hidden="true"></i> แก้ไข</a>'+' '+
