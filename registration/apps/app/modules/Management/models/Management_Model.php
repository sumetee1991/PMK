...
class Management_Model extends CI_Model
{
    ...
    */
    ...
    function GetQueueRegister1($data){
        $strquery = "
                        SELECT * 
                        , ((date_part('epoch'::text, NOW()) * 1000::double precision) - lastworklist_cwhen) AS lastworklist_waiting
                        FROM vw_patientqueue 
    ...
    function InsertLogAPI($data){
        $InsertStatus = "INSERT INTO tr_api_status(hn,idcard,cuser,refno,status_api,status_get,system_type) VALUES('".$data['p_run_hn'].'/'.$data['p_year_hn']."','".$data['pid']."','".$data['p_user_created']."','".$data['refno']."','".$data['code']."','success','management') RETURNING uid";
