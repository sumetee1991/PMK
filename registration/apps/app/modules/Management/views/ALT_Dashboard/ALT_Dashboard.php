            	...
            	<div class="row">
					...
					<div class="col">
						<div class="row btn_row">
							<a href="#" class="active"><button>รอเรียก</button></a>
							<a href="./Revert_Dashboard/1"><button>คิวที่เสร็จสิ้นแล้ว</button></a>
					        <a href="./Revert_Cancel/1"><button>คิวที่ถูกยกเลิก</button></a>
						</div>
					</div>
				</div><br>
		    </div>
...
<div class="col-1"></div>
	<div class="col-3">
		<div class="row btn_row">
			<a href="#" class="active hover1">
				<button class="hover1" style="border-radius: 7px;" id="detail1"></button>
			</a>
...
<script>
	...
	// $(document).on('click', '.action_detail', async function() {
	// 		var PostDataURL = 'controller/Management.php';
	// 		var select=1;
	// 		$.post(PostDataURL,{
	// 			event : 'Follow',
	// 			patientuid: select,
