            	...
            	<div class="row">
					...
					<div class="col">
						<div class="row btn_row">
							...
							<a href="./Revert_Dashboard/2"><button>คิวที่เสร็จสิ้นแล้ว</button></a>
					        <a href="./Revert_Cancel/2"><button>คิวที่ถูกยกเลิก</button></a>
						</div>
					</div>
				</div><br>
		    </div>
	...
	<div class="col-3">
		<div class="row btn_row">
			<a href="#" class="active hover1">
				<button class="hover1" style="border-radius: 7px;" id="detail2"></button>
			</a>
